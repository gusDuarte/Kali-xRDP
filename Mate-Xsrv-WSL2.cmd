...
%GO% "DEBIAN_FRONTEND=noninteractive apt-fast -y install ubuntu-mate-core ubuntu-mate-desktop"  > "%TEMP%\Kali-xRDP\%TIME:~0,2%%TIME:~3,2%%TIME:~6,2% Mate desktop.log" 2>&1

@REM ## Classic Mate fashion
@REM %GO% "DEBIAN_FRONTEND=noninteractive apt-fast -y install mate-desktop-environment mate-desktop-environment-extra"  > "%TEMP%\Kali-xRDP\%TIME:~0,2%%TIME:~3,2%%TIME:~6,2% Mate desktop.log" 2>&1
